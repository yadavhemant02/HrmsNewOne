...
import carImage from '../../assets/images/career1.png';
import carImage2 from '../../assets/images/career2.png';
  ...
  return (
    <Box>
      <HeroSection>
        ...
        <AnimatedHeroBackground backgroundImage={carImage2} />
        <Container>
          <HeroContent 
            isMobile={isMobile}
          ...
          >
            ...
            >
              HRHaaT offers a powerful platform to create a branded career page that truly reflects your company culture and attracts top talent
            </MotionTypography>
          </HeroContent>
        </Container>
      </HeroSection>
      ...
      <Section
        title="Career Page "
        image={carImage}
        description="This customizable tool allows you to design a career page that reflects your company's values, culture, and unique opportunities. By creating a visually appealing and informative career page, you can attract top talent who are aligned with your organizational goals. Gain an edge by tapping into the vast pool of talent on LinkedIn, the world's largest professional network"
        isImageLeft={false}
      />
