  ...
  return (
    <Box>
      <HeroSection>
        ...
        <AnimatedHeroBackground backgroundImage={performanceImage} />
        <Container>
          <HeroContent 
            isMobile={isMobile}
          ...
          >
            ...
            >
              Simplify and centralize the process of creating, approving, and managing job requisitions to accelerate your hiring workflow.
            </MotionTypography>
          </HeroContent>
        </Container>
      </HeroSection>
      ...
      <Section
        ...
        description="Streamline your hiring process with Job Pipelines in HRHaaT. Track the progress of candidates through each stage of the hiring process, from application to offer"
        isImageLeft={false}
      />
      ...
      <Section
        title="Job Templates"
        image={orgImage}
        description="Create standardized Job Templates for recurring positions. RapidHR ATS allows you to save and reuse templates, saving time and ensuring consistency in your job postings."
        isImageLeft={true}
      />

      <Section
        title="Customizable Hiring Steps"
        image={workflowImage}
        description="Tailor your hiring process to fit your organization's needs with Customizable Hiring Steps. RapidHR ATS enables you to define and manage each step of the recruitment process, ensuring a personalized and effective approach."
        isImageLeft={false}
      />
      ...
      <Section
        title="Requisitions"
        image={workflowImage}
        description="Manage job requisitions effortlessly with RapidHR ATS. Create, approve, and track job requisitions in one centralized platform, ensuring a streamlined and efficient process from start to finish."
        isImageLeft={true}
      />
    </Box>
  );
