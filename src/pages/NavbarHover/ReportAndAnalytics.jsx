  ...
  return (
    <Box>
      <HeroSection>
        ...
        <AnimatedHeroBackground backgroundImage={report1} />
        <Container>
          <HeroContent 
            isMobile={isMobile}
          ...
          >
            ...
            >
              Explore interactive reports and visual summaries that help transform raw data into strategic direction.
            </MotionTypography>
          </HeroContent>
        </Container>
      </HeroSection>
      ...
      <Section
        title="From Patterns to Performance"
        image={report2}
