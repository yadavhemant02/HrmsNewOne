...
const ViewExperienceLetterDialog = ({ open, onClose, empCode }) => {
  ...
  const fetchPdf = async () => {
    ...
    try {
      const response = await axios.get(
        `${base_hr}/hr-handler/api/experience-letter/view-experience-leter-pdf?empCode=${empCode}`,
        {
          headers: {
            'accept': '*/*'
          }
        ...
        {loading ? (
          ...
          <ErrorContainer>
            ...
            <Typography variant="h6" gutterBottom>
              Error Loading Experience Letter
            </Typography>
            <Alert 
              severity="error" 
              sx={{ 
...
export default ViewExperienceLetterDialog;